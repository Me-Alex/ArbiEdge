...
const ROMANIAN_BOOKMAKER_COVERAGE = Object.freeze([
  ...
  direct('Winboss', 'winboss.ro', 'XSportProvider'),
  direct('PowerBet', 'powerbet.ro', 'XSportProvider'),
  direct('Magnumbet', 'magnumbet.ro', 'XSportProvider'),
  direct('Excelbet', 'excelbet.ro', 'XSportProvider'),
