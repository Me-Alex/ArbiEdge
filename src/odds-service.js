const { auditOdds } = require('./odds-audit');
...
class OddsService {
  ...
  /**
   * Compute odds movement between the latest and previous snapshot.
   * Returns a map of eventKey -> { bookmaker, market, outcome, current, previous, direction }
   */
  getOddsMovement() {
