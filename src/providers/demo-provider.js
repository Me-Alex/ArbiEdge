...
function createBookmaker(name, home, draw, away, baseTime, eventIndex, bookmakerIndex, sport) {
  ...
  if (!isTwoWay) {
    ...
    markets.secondHalfDrawNoBet = {
      home: round(Math.max(1.1, home - 0.12 + bookmakerIndex * 0.03)),
      away: round(Math.max(1.1, away - 0.35 + bookmakerIndex * 0.04)),
    };
    ...
    markets.market_clean_sheet_home = {
      ...
      no: round(1.64 + bookmakerIndex * 0.05 + bookmakerIndex * 0.12),
    };
    markets.market_clean_sheet_away = {
      yes: round(2.72 + eventIndex * 0.07 - bookmakerIndex * 0.04 + bookmakerIndex * 0.09),
      no: round(1.44 + bookmakerIndex * 0.05 + bookmakerIndex * 0.11),
    };
    ...
    markets.asianTotalGoals_0_5 = {
      over: round(1.18 + bookmakerIndex * 0.03),
      under: round(4.8 + eventIndex * 0.05),
    };
    markets.asianTotalGoals_1_5 = {
    ...
    markets.asianTotalGoals_3_25 = {
      over: round(2.55 + bookmakerIndex * 0.1),
      under: round(1.48 + eventIndex * 0.02),
    };
    ...
    markets.market_total_goluri_impar_par = {
      ...
      even: round(1.88 + eventIndex * 0.03 - bookmakerIndex * 0.02),
    };
    markets.totalGoals_0_5 = {
    ...
    markets.secondHalfBothTeamsToScore = {
      yes: round(2.85 + bookmakerIndex * 0.1),
      no: round(1.38 + eventIndex * 0.02),
    };
    markets.secondHalfTotalGoals_0_5 = {
      over: round(1.52 + bookmakerIndex * 0.04),
      under: round(2.45 + eventIndex * 0.03),
    };
    markets.secondHalfAsianTotalGoals_0_5 = {
      over: round(1.48 + bookmakerIndex * 0.04),
      under: round(2.55 + eventIndex * 0.03),
    };
    markets.secondHalfAsianTotalGoals_1_5 = {
      over: round(2.05 + bookmakerIndex * 0.06),
      under: round(1.75 + eventIndex * 0.03),
    };
    markets.asianTotalCorners_9_5 = {
      over: round(1.95 + bookmakerIndex * 0.06),
      under: round(1.85 + eventIndex * 0.02),
    };
